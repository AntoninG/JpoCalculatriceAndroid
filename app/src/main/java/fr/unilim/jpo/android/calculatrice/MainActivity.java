package fr.unilim.jpo.android.calculatrice;
...
public class MainActivity extends AppCompatActivity {
    ...
    // Retourne la valeur (double) affichée à l'écran
    private Double getEcranValue() {
        return Double.valueOf(ecran.getText().toString());
    }
}
